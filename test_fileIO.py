...
fileIO.question.newQuestion("e", "title1", "aaaaaaaa", ["1", "2", "3"], ['a', 'b', 'c'], ["a"])
fileIO.question.newQuestion("e", "title2", "aaaaaaaa", ['d', 'e', 'f'], ["d", "e", "f"], ["d", "e"])
fileIO.question.newQuestion("e", "title3", "aaaaaaaa", ["a", "b", "c"], ['1', '2', '3'], ['1'])

fileIO.question.update("1", "new title",'aaa', ["d", "e", "f"], ['1','2','3'], ["1"])
...
print('format:')
print(fileIO.question.read('0'))
print(fileIO.format.questionToDic(fileIO.question.read('0')))
